...
- act(moveontrap_up,(x,y),(x',y'),time(t))

  Conditions:

    t>0 ∧ man(x,y) ∧ next(y,y') ∧ trap(x,y') ∧ ¬block(x,y') ∧ empty(x,y') ∧ ¬skeleton(x,y') ∧ ¬lock(x,y') ∧ ¬key(x,y') ∧
    ¬demoness(x,y')
...
- act(moveontrap_down,(x,y),(x',y'),time(t))

  Conditions:

    t>0 ∧ man(x,y) ∧ next(y',y) ∧ trap(x,y') ∧ ¬block(x,y') ∧ empty(x,y') ∧ ¬skeleton(x,y') ∧ ¬lock(x,y') ∧ ¬demoness(x,y') ∧
    ¬key(x,y')
...
- act(moveontrap_left,(x,y),(x',y'),time(t))
...
- act(moveontrap_right,(x,y),(x',y'),time(t))
...
- act(kickblockup,(x,y),(x',y'),time(t))

  Conditions:

    t>0 ∧ man(x,y) ∧ next(y,y')  ∧ next(y',y") ∧ block(x,y') ∧ ¬block(x,y") ∧ empty(x,y") ∧ ¬skeleton(x,y") ∧ ¬lock(x,y") ∧
    ¬demoness(x,y")
...
- act(kickblockdown,(x,y),(x',y'),time(t))
...
- act(kickblockleft,(x,y),(x',y'),time(t))
...
- act(kickblockright,(x,y),(x',y'),time(t))
...
- act(kickskeletonup,(x,y),(x',y'),time(t))

  Conditions:

    t>0 ∧ man(x,y) ∧ next(y,y')  ∧ next(y',y") ∧ skeleton(x,y') ∧ empty(x,y") ∧ ¬squeleton(x,y") ∧ ¬block(x,y") ∧ ¬lock(x,y") ∧
    ¬demoness(x,y")
...
- act(kickskeletondown,(x,y),(x',y'),time(t))
...
- act(kickskeletonleft,(x,y),(x',y'),time(t))

  Conditions:

    t>0 ∧ man(x,y) ∧ next(x,x') ∧ next(x',x") ∧ skeleton(x',y) ∧ empty(x",y) ∧ ¬squeleton(x",y) ∧ ¬block(x",y) ∧ ¬lock(x",y) ∧
    ¬demoness(x",y)
...
- act(kickskeletonright,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_trap_up,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_trap_down,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_trap_left,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_trap_right,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_wall_up,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_wall_down,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_wall_left,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_wall_right,(x,y),(x',y'),time(t))
...
- act(kickskeletonup_on_block_up,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_block_down,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_block_left,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_block_right,(x,y),(x',y'),time(t))
...
- act(kickskeleto_on_lock_up,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_lock_down,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_lock_left,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_lock_right,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_skeleton_up,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_skeleton_down,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_skeleton_left,(x,y),(x',y'),time(t))
...
- act(kickskeleton_on_skeleton_right,(x,y),(x',y'),time(t))
...
- act(getkeyright,(x,y),(x',y'),time(t))
...
- act(openlockdown,(x,y),(x',y'),time(t))
...
- act(openlockleft,(x,y),(x',y'),time(t))
...
- act(openlockright,(x,y),(x',y'),time(t))
...
- act(kickblock_on_block_up,(x,y),(x',y'),time(t))
...
- act(kickblock_on_block_down,(x,y),(x',y'),time(t))
...
- act(kickblock_on_block_left,(x,y),(x',y'),time(t))
...
- act(kickblock_on_block_right,(x,y),(x',y'),time(t))
...
- act(kickblock_on_lock_up,(x,y),(x',y'),time(t))
...
- act(kickblock_on_lock_down,(x,y),(x',y'),time(t))
...
- act(kickblock_on_lock_left,(x,y),(x',y'),time(t))
...
- act(kickblock_on_lock_right,(x,y),(x',y'),time(t))
...
- act(kickblock_on_wall_up,(x,y),(x',y'),time(t))
...
- act(kickblock_on_wall_down,(x,y),(x',y'),time(t))
...
- act(kickblock_on_wall_left,(x,y),(x',y'),time(t))
...
- act(kickblock_on_wall_right,(x,y),(x',y'),time(t))
...
- act(kickblock_on_skeleton_up,(x,y),(x',y'),time(t))
...
- act(kickblock_on_skeleton_down,(x,y),(x',y'),time(t))
...
- act(kickblock_on_skeleton_left,(x,y),(x',y'),time(t))
...
- act(kickblock_on_skeleton_right,(x,y),(x',y'),time(t))
